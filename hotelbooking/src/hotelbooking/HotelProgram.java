...
class Group7
{
    public void Print1()
    {
        ...
        System.out.println("                             Team Name: Group7");
        System.out.println("                            Team leader: Sahana Akter");
        System.out.println("                            Team Member: Lubna Sultana,Samira Saimee");


    }
}

class Derived extends Group7 {
    public void Print2() {
        System.out.println("********************************************************");
...
public class HotelProgram //child
{
    ...
    public static void main(String[] args) throws IOException //(Error Handling)//Encapsulation
    {
        ...
        while (MainMenu)
        {
            ...
            {
                System.out.println("*************************************************************************************");
                System.out.println("                    Hello and Welcome to our ♡ Diamond Hotel Booking ♡ ");
    ...
    private static void Update(Room[] myHotel,int roomNum)
    {
        Scanner input = new Scanner(System.in);
        String roomName;
        System.out.println("Which name want to change:");
        roomName = input.next();
        int x;
        boolean Checker = false;
        for (x = 0; x < myHotel.length; x++)
        {
            if (roomName.equals(myHotel[x].getName()))
            {
                ...
                roomName = input.next();
                myHotel[roomNum].setName(roomName);
                System.out.println("The customer name is change ");
                Checker = true;
            }
        }
        if (Checker == false)
